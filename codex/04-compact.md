...
![Codex 3 种 Compact 实现选择树](/images/opencode/codex-04-hero.svg)
...
![Local Compact 内循环：ContextWindowExceeded → remove_first_item](/images/opencode/codex-04-loop.svg)
...
![BeforeLastUserMessage vs DoNotInject 注入策略](/images/opencode/codex-04-inject.svg)
...
![Codex vs Claude Code：压缩哲学对比](/images/opencode/codex-04-vs.svg)
