...
![Codex Agent Tree 拓扑：Root → 子 Agent → Worker](/images/codex/05-hero.png)
...
![AgentStatus 7 状态机：PendingInit → Running → Completed/Errored/Shutdown](/images/codex/05-states.png)
...
![V1 vs V2 协作工具矩阵对比](/images/codex/05-tools.png)
...
![CSV 批处理 Map-Reduce：CSV → Slot Pool → Workers → Output](/images/codex/05-csv.png)
