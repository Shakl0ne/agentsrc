      ...
      '/codex/': [
        {
          ...
          items: [
            ...
            { text: '5. 工具系统与 MCP 双向集成', link: '/codex/05-tools-mcp' },
            { text: '6. 安全架构：策略指令与 OS 沙箱', link: '/codex/06-sandboxing' },
            { text: '7. 多 Agent 编排：V1/V2 路由机制', link: '/codex/07-multi-agents' },
            { text: '8. App Server：协议边界与解耦', link: '/codex/08-app-server' },
          ],
        },
      ],
      '/claudecode/': [
        {
          ...
          items: [
            ...
            { text: '3. 工具与命令系统', link: '/claudecode/03-tools' },
            { text: '4. 对话压缩：5 级机制', link: '/claudecode/04-compact' },
            { text: '5. Agent 系统', link: '/claudecode/05-agents' },
            { text: '6. 权限系统：7 种权限模式', link: '/claudecode/06-permissions' },
            { text: '7. MCP 集成架构与 Bridge', link: '/claudecode/07-mcp' },
            { text: '8. 记忆系统与上下文注入', link: '/claudecode/08-memory' },
          ],
        },
      ],
      '/deepseek/': [
        {
          ...
          items: [
            ...
            { text: '3. agent-loop：可换的默认驱动', link: '/deepseek/03-agent-loop' },
            { text: '4. 会话日志与上下文投影', link: '/deepseek/04-session-log' },
            { text: '5. capability 缝与执行世界', link: '/deepseek/05-capability-seams' },
            { text: '6. 扩展的三个极致', link: '/deepseek/06-extensions' },
          ],
        },
      ],
      '/reading/': [
